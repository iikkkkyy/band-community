...
void diSetup() {
  ...
  getIt.registerFactory(
      () => GetUserProfileImageUseCase(getIt<ProfileRepository>()));
  getIt.registerFactory(() => CreateBandUseCase(getIt<BandRepository>()));
  ...
  getIt.registerFactory(
      () => MainViewModel(getIt<GetUserProfileImageUseCase>()));
